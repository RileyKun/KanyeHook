	...
	try
	{
		...
		//Aimbot
		{
			...
			//Projectile
			{
				...
				SAVE_VAR(Vars::Misc::CL_Move::Fast);
		...
		//Misc
		{
			...
			// CL_Move
			{
				...
				SAVE_VAR(Vars::Misc::CL_Move::DTs);
		...
		//AntiHack
		{
			//AntiAim
			{
				...
				SAVE_VAR(Vars::AntiHack::AntiAim::Flip);
				SAVE_VAR(Vars::AntiHack::AntiAim::Time);
				SAVE_VAR(Vars::AntiHack::AntiAim::first);
				SAVE_VAR(Vars::AntiHack::AntiAim::second);
				SAVE_VAR(Vars::AntiHack::AntiAim::FakeFirst);
				SAVE_VAR(Vars::AntiHack::AntiAim::FakeSecond);
			}
			//Resolver
			{
	...
	try
	{
		...
		//Aimbot
		{
			...
			//Projectile
			{
				...
				LOAD_VAR(Vars::Misc::CL_Move::Fast);
		...
		//Misc
		{
			...
			// CL_Move
			{
				...
				LOAD_VAR(Vars::Misc::CL_Move::DTs);
		...
		//AntiHack
		{
			//AntiAim
			{
				...
				LOAD_VAR(Vars::AntiHack::AntiAim::Flip);
				LOAD_VAR(Vars::AntiHack::AntiAim::Time);
				LOAD_VAR(Vars::AntiHack::AntiAim::first);
				LOAD_VAR(Vars::AntiHack::AntiAim::second);
				LOAD_VAR(Vars::AntiHack::AntiAim::FakeFirst);
				LOAD_VAR(Vars::AntiHack::AntiAim::FakeSecond);
