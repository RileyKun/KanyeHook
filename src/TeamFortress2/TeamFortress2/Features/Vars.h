...
namespace Vars
{
	...
	namespace Aimbot
	{
		namespace Global
		{
			...
			inline CVar<int> Range{ 148 };
			inline CVar<int> Points{ 250 };
		}
		...
		namespace Projectile
		{
			...
			inline CVar<float> StrafeChance{ 70.f };
	...
	namespace Visuals
	{
		...
		inline CVar<float> ThirdpersonDist{ 150.f };
	...
	namespace AntiHack
	{
		namespace AntiAim
		{
			...
			inline CVar<float> Time{ 25 };
			inline CVar<float> first{ 0 };
			inline CVar<float> second{ 0 };
			inline CVar<float> FakeFirst{ 0 };
			inline CVar<float> FakeSecond{ 0 };
