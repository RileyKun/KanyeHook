...
//it does alot
#define mynuts (CONTENTS_SOLID | CONTENTS_WINDOW | CONTENTS_GRATE | CONTENTS_AUX | CONTENTS_BLOCKLOS | CONTENTS_OPAQUE | CONTENTS_PLAYERCLIP | CONTENTS_MONSTER | CONTENTS_LADDER | CONTENTS_TRANSLUCENT)
