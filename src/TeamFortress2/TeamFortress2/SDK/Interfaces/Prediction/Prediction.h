...
public:
	...
	void RunCommand(CBaseEntity *player, CUserCmd *ucmd, CMoveHelper *moveHelper)
	{
		return GetVFunc<void(__thiscall*)(void*, CBaseEntity*, CUserCmd*, CMoveHelper*)>(this, 17)(this, player, ucmd, moveHelper);
	}
